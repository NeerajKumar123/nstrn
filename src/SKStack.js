    ...
    <SafeAreaView style={{flex: 1, backgroundColor: Colors.WHITE}}>
      <NavigationContainer>
        <Stack.Navigator
          ...
          />
          <Stack.Screen
            name="RemainedDetailsTaxYrFlow"
            component={RemainedDetailsTaxYrFlow}
            options={{title: 'RemainedDetailsTaxYrFlow', headerShown: false}}
          />
          <Stack.Screen
            name="BankingAndMore"
